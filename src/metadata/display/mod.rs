...
pub const PREDEFINED_COLORSPACE_PRIMARIES: &[[f32; 8]] = &[
    ...
    [0.693 , 0.304 , 0.208 , 0.761 , 0.1467, 0.0527, 0.3127 , 0.329  ], //  9, DolbyCinemaWCG
    [0.6867, 0.3085, 0.231 , 0.69  , 0.1489, 0.0638, 0.3127 , 0.329  ], // 10, Canon DP-V2420
    [0.6781, 0.3189, 0.2365, 0.7048, 0.141 , 0.0489, 0.3127 , 0.329  ], // 11, Sony BVM-X300
    [0.68  , 0.32  , 0.265 , 0.69  , 0.15  , 0.06  , 0.3127 , 0.329  ], // 12, DCI-P3 D65
    [0.7042, 0.294 , 0.2271, 0.725 , 0.1416, 0.0516, 0.3127 , 0.329  ], // 13, Pulsar
    [0.6745, 0.310 , 0.2212, 0.7109, 0.152 , 0.0619, 0.3127 , 0.329  ], // 14, Eizo CG3145
    [0.6805, 0.3191, 0.2522, 0.6702, 0.1397, 0.0554, 0.3127 , 0.329  ], // 15, LG2017 B7 OLED
    [0.6838, 0.3085, 0.2709, 0.6378, 0.1478, 0.0589, 0.3127 , 0.329  ], // 16, PRM32FHD-QT
    [0.6753, 0.3193, 0.2636, 0.6835, 0.1521, 0.0627, 0.3127 , 0.329  ], // 17, Apollo PRD DCI-P3 Model
    [0.6981, 0.2898, 0.1814, 0.7189, 0.1517, 0.0567, 0.3127 , 0.329  ], // 18, Apollo PRD WCG Model
];
